        ...
        {["Date", "Horaire", "Infos", "Confirmé"].map((label, i) => {
          ...
          return (
            <div key={label} className="flex items-center gap-2 flex-1">
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold shrink-0 transition-all duration-300 ${
                  i <= stepIdx
              ...
              <span
                className={`text-xs hidden sm:block ${i <= stepIdx ? "text-white" : "text-slate-500"}`}
              >
                {label}
              </span>
              {i < 3 && (
                <div
                  className={`flex-1 h-px ${i < stepIdx ? "bg-primary" : "bg-white/10"}`}
                />
              )}
            </div>
          );
                ...
                <button
                  ...
                  className={`relative aspect-square rounded-xl flex items-center justify-center text-sm font-medium transition-all duration-200 ${
                    disabled
                      ...
                      : "text-white hover:bg-primary/20 hover:scale-105 cursor-pointer"
        ...
        <div className="animate-fade-in-up">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-slate-400 mt-1">
              Choisissez un créneau de 30 minutes
            </p>
          </div>
        ...
        <div className="animate-fade-in-up">
          ...
          <div className="flex items-center gap-3 p-4 rounded-xl bg-primary/10 border border-primary/20 mb-6">
            ...
            <div>
              ...
              <p className="text-primary text-xs">{selectedSlot} — 30 min</p>
            </div>
          </div>
