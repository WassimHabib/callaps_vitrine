  ...
  return (
    <div className="min-h-screen bg-bg-deep">
      ...
      <main className="max-w-3xl mx-auto px-6 pb-20">
        <h1 className="text-3xl md:text-4xl font-bold text-stroke mb-2">Mentions Légales</h1>
        ...
        <div className="space-y-10 text-stroke/85 leading-relaxed">
          {/* Éditeur */}
          <section>
            <h2 className="text-xl font-semibold text-stroke mb-4">1. Éditeur du site</h2>
            <p>Le site <strong className="text-stroke">callaps.fr</strong> est édité par :</p>
            <ul className="mt-3 space-y-1 text-stroke/60">
              <li><strong className="text-stroke">Raison sociale :</strong> WH Consulting (Wevlap)</li>
              <li><strong className="text-stroke">Forme juridique :</strong> Micro-entreprise</li>
              <li><strong className="text-stroke">Siège social :</strong> Île-de-France, France</li>
              <li><strong className="text-stroke">SIRET :</strong> En cours d&apos;immatriculation</li>
              <li><strong className="text-stroke">Responsable de la publication :</strong> Wassim Habib</li>
              ...
              <li><strong className="text-stroke">Téléphone :</strong> <a href="tel:+33651370395" className="text-secondary hover:opacity-80 transition-colors">06 51 37 03 95</a></li>
            </ul>
          </section>

          {/* Hébergeur */}
          <section>
            <h2 className="text-xl font-semibold text-stroke mb-4">2. Hébergement</h2>
            <p>Le site est hébergé par :</p>
            <ul className="mt-3 space-y-1 text-stroke/60">
              <li><strong className="text-stroke">Hébergeur :</strong> Vercel Inc.</li>
              <li><strong className="text-stroke">Adresse :</strong> 440 N Barranca Ave #4133, Covina, CA 91723, États-Unis</li>
              <li><strong className="text-stroke">Site web :</strong> vercel.com</li>
            </ul>
          </section>

          {/* Propriété intellectuelle */}
          <section>
            <h2 className="text-xl font-semibold text-stroke mb-4">3. Propriété intellectuelle</h2>
            <p>
          ...
          {/* Responsabilité */}
          <section>
            <h2 className="text-xl font-semibold text-stroke mb-4">4. Limitation de responsabilité</h2>
            <p>
          ...
          {/* Liens hypertextes */}
          <section>
            <h2 className="text-xl font-semibold text-stroke mb-4">5. Liens hypertextes</h2>
            <p>
          ...
          {/* Cookies */}
          <section>
            <h2 className="text-xl font-semibold text-stroke mb-4">6. Cookies</h2>
            <p>
              ...
              <Link href="/confidentialite" className="text-secondary hover:opacity-80 transition-colors">
          ...
          {/* Droit applicable */}
          <section>
            <h2 className="text-xl font-semibold text-stroke mb-4">7. Droit applicable</h2>
            <p>
