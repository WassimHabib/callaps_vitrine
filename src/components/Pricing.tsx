      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
            <span className="gradient-text">Des tarifs simples et transparents</span>
          </h2>
          <p className="text-lg text-slate-400">
            Sans engagement. Évoluez à votre rythme.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          ...
          <div className="glass rounded-2xl p-8 transition-transform duration-300 hover:scale-[1.02]">
            ...
            <p className="text-slate-400 mb-8">
              Idéal pour démarrer l&apos;automatisation de vos appels.
            </p>

            <ul className="space-y-4 mb-8">
              {[
                "1 agent IA configuré",
                "500 appels/mois inclus",
          ...
          <div className="relative glass rounded-2xl p-8 ring-2 ring-primary/30 shadow-xl shadow-primary/10 lg:scale-105 transition-transform duration-300 hover:scale-[1.07] lg:hover:scale-[1.07]">
            ...
            <h3 className="text-xl font-semibold text-white mb-2 mt-2">Business</h3>
            <div className="mb-4">
              <span className="text-5xl font-bold text-white">990€</span>
              <span className="text-lg text-slate-400"> /mois</span>
            </div>
            <p className="text-slate-400 mb-8">
              Pour les entreprises qui veulent scaler leur communication.
            </p>

            <ul className="space-y-4 mb-8">
              {[
                "3 agents IA configurés",
                "2 000 appels/mois inclus",
          ...
          <div className="glass rounded-2xl p-8 transition-transform duration-300 hover:scale-[1.02]">
            ...
            <p className="text-slate-400 mb-8">
              Solution complète pour les grands volumes et besoins spécifiques.
            </p>

            <ul className="space-y-4 mb-8">
              {[
                "Agents IA illimités",
                "Volume d'appels sur mesure",
