    ...
    plans: [
      {
        ...
        price: { fr: "490€", en: "€490" },
        description: {
          fr: "Idéal pour démarrer l'automatisation de vos appels.",
          en: "Ideal to start automating your calls.",
        },
        features: [
          { fr: "1 agent IA configuré", en: "1 configured AI agent" },
          { fr: "500 appels/mois inclus", en: "500 calls/month included" },
          { fr: "Intégration CRM basique", en: "Basic CRM integration" },
          { fr: "Tableau de bord analytics", en: "Analytics dashboard" },
      ...
      },
      {
        ...
        price: { fr: "990€", en: "€990" },
        description: {
          fr: "Pour les entreprises qui veulent scaler leur communication.",
          en: "For businesses looking to scale their communication.",
        },
        features: [
          { fr: "3 agents IA configurés", en: "3 configured AI agents" },
          { fr: "2 000 appels/mois inclus", en: "2,000 calls/month included" },
          { fr: "Intégrations CRM avancées", en: "Advanced CRM integrations" },
          { fr: "Analytics & reporting avancés", en: "Advanced analytics & reporting" },
          { fr: "Support prioritaire", en: "Priority support" },
          { fr: "Personnalisation vocale", en: "Voice customization" },
        ],
      },
      {
        ...
        description: {
          fr: "Solution complète pour les grands volumes et besoins spécifiques.",
          en: "Complete solution for high volumes and specific needs.",
        },
        features: [
          { fr: "Agents IA illimités", en: "Unlimited AI agents" },
          { fr: "Volume d'appels sur mesure", en: "Custom call volume" },
          ...
          { fr: "Formation équipe incluse", en: "Team training included" },
        ],
      },
    ],
  },
